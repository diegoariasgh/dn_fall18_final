...
void setup() {
  //size(1280, 800); //size of the sketch to match the camera size
  fullScreen();
  //initializing camera
...
void draw() {
  ...
  noStroke();
  fill(255, 100);
  rect(40, 25, 620, 120, 7);
  rect(width - 105, 25, 80, 90, 7);
  stroke(8);
  fill(50);

  text("Use the UP and DOWN arrows to change the size of the effect", 50, 50);
  text("Use the 1, 2, 3 key to change the effect", 50, 70);
  text("Use the R key to reset the effect", 50, 90);
  text("Use the P key to pause the effect", 50, 110);
  text("Use the SPACEBAR to snap a pic", 50, 130);
